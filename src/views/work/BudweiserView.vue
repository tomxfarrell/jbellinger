...
<template>
  <div class="work-page">
    ...
    <ContentBlock>
      <p>
        For a Canadian hockey promotion “Playoff Payoff”, the NHL and Budweiser
        teamed up to offer fans the chance to win tickets for life. I was tasked
        with creating the promotional logo design sought to combine the two
        worlds of hockey and beer seamlessly.
      </p>
      <p>
        To achieve this, I incorporated several hockey elements, such as the red
        light, netting, and goal posts, into the design. These cues not only
        helped to create a cohesive and visually appealing design, but also
        tapped into the excitement and energy of the sport, effectively
        capturing the attention of hockey fans and beer enthusiasts alike. The
        end result was a design that effectively promoted the partnership
        between Budweiser and the NHL, and provided an enticing opportunity for
        fans to engage with the brand and potentially win an incredible prize.
      </p>
    </ContentBlock>
