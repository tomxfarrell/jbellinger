  ...
  <div class="work-page">
    ...
    <ContentBlock>
      ...
      <p>
        ...
        for a week to view and get close up with famous props, costumes,
        weaponry, and even take part in an interactive archery experience.
        <strong
          >Oh, and of course, to sit atop the Iron Throne and brag about it on
          Instagram.</strong
        >
      </p>
    </ContentBlock>
